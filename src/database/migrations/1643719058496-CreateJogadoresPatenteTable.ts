...
export class CreateJogadoresPatenteTable1643719058496 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.dropForeignKey('tb_jogador_patente', "fk_jogador_patent_p");
