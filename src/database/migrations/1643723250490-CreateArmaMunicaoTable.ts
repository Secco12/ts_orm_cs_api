...
export class CreateArmaMunicaoTable1643723250490 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.dropForeignKey('tb_arma_municao', "fk_arma_municao_m");
